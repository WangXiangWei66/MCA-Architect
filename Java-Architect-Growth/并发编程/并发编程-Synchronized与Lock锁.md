...
* **单向链表：** 当持有ReentrantLock锁的线程，执行了await方法后，会将持有锁的线程封装为Node，释放锁资源，扔到这个单向链表里。等待被signal唤醒，唤醒后就扔回同步队列。![image.png](https://fynotefile.oss-cn-zhangjiakou.aliyuncs.com/fynote/fyfile/2746/1700739126043/c2a9d69792124d628f47fcb5ec372999.png)
